...
## 5. Project-Specific Product Rules

These rules are mandatory for NailArt Studio development:

- Mobile-first is the primary product constraint. Clients book services on phones; nail artists manage appointments, clients, schedules, and works on phones.
