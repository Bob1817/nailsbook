  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-brand-bg px-4">
      <div className="mx-auto w-full max-w-md rounded-[32px] border border-line bg-surface p-8 text-center shadow-lg">
        ...
        {error && (
          <p className="mt-4 rounded-xl bg-[var(--nb-page)] px-4 py-3 text-xs text-[var(--nb-secondary)]">
            {error.message}
          </p>
        )}
        <div className="mt-6 flex gap-3">
          <button
            onClick={onReset}
            className="flex-1 min-h-12 inline-flex items-center justify-center rounded-full bg-gradient-to-r from-brand to-brand-deep px-6 text-[15px] font-bold text-white shadow-lg shadow-black/50 transition active:scale-[0.98]"
          >
