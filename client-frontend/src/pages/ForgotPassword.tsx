...
const inputClass =
  'h-12 w-full rounded-xl border border-[var(--nb-line)] bg-white px-4 text-base focus:border-[var(--nb-control)] focus:outline-none focus:ring-2 focus:ring-[var(--nb-line)]';
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-4">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="h-12 shrink-0 rounded-xl bg-[var(--nb-page)] px-4 text-sm font-semibold text-[var(--nb-secondary)] disabled:opacity-50"
          >
